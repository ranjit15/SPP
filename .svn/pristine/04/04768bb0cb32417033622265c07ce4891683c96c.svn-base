...
public class TestScrubber extends MediaPlayerTest {
    ...
    public void testVideoScrubbing() throws AWTException {
         ...
         * 
         * Move the TAB to Chapter 4 and move the video forward by selecting
         * right arrow, Measure the time between point where the video started
         * and then stopped.
         */
        ...
        // 20 sec is bit long time, since my internet is slow I have added it
        // more, should reduce it after testing it on
        // different machines
        ...
        /*
         * Get the timings of the video from the current timeline and then
        ...
        /*
         * Make the driver sleep for 5 seconds, so that video moves to the
    ...
    /* Convert the String Value of "TIme" into Seconds */
